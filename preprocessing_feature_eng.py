...
games_filtered = games.loc[:, ['date', 'game', 'home_team','away_team','home_goals', 'away_goals', 'home_xg', 'away_xg']]
...
df_home = final_df[['date', 'home_team', 'away_team', 'home_goals', 'away_goals', 'home_xg', 'away_xg']].copy()


df_home.columns = ['date', 'team', 'opponent', 'goals_for', 'goals_against', 'xG_for', 'xG_against']

df_home['is_home'] = 1


df_away = final_df[['date', 'away_team', 'home_team', 'away_goals', 'home_goals', 'away_xg', 'home_xg']].copy()

df_away.columns = ['date', 'team', 'opponent', 'goals_for', 'goals_against', 'xG_for', 'xG_against']
...
## And now lets's order the dataframe by team and date and compute the points gained by the team 
